...
with slim.arg_scope(alexnet_v2_arg_scope()):
    logits, end_points = alexnet_v2(images, num_classes=classes, is_training=True)
...
learning_rate = tf.Variable(initial_value=0.0001, trainable=False, name="learning_rate", dtype=tf.float32)
...
correct_prediction = tf.equal(labels, tf.argmax(end_points['alexnet_v2/fc8'], 1), name="correct_prediction")
